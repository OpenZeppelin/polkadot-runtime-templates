...
The construction of Merlin transcripts in particular must be closely reviewed in the above crates to ensure secure usage of the merlin Rust library constructing transcripts used in ZKPS.

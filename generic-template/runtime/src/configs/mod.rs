...
use frame_support::{
    ...
    parameter_types,
    traits::{
        AsEnsureOriginWithArg, ConstU32, Contains, EitherOfDiverse, InstanceFilter, TransformOrigin,
    },
...
use sp_runtime::{traits::IdentityLookup, Perbill, Permill, RuntimeDebug};
...
// TODO: split into own file oz_config.rs
pub struct Configuration;
#[rustfmt::skip]
impl OzSystemConfig for Configuration {
    // Exposed to the User:
    ...
    type PreimageManagerOrigin = EnsureRoot<AccountId>;
    ...
    // Pallet Preimage
    type PreimageConsideration = frame_support::traits::fungible::HoldConsideration<
        AccountId,
        Balances,
        PreimageHoldReason,
...
use oz_wrappers::{OzSystem, OzSystemConfig};
...
impl frame_system::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    ...
    type BlockHashCount = <OzSystem<Configuration> as frame_system::DefaultConfig>::BlockHashCount;
    /// The weight of database operations that the runtime can invoke.
    type DbWeight = <OzSystem<Configuration> as frame_system::DefaultConfig>::DbWeight;
    /// The type for hashing blocks and tries.
    type Hash = <OzSystem<Configuration> as frame_system::DefaultConfig>::Hash;
    /// The maximum length of a block (in bytes).
    type BlockLength = <OzSystem<Configuration> as frame_system::DefaultConfig>::BlockLength;
    /// Block & extrinsics weights: base values and limits.
    type BlockWeights = <OzSystem<Configuration> as frame_system::DefaultConfig>::BlockWeights;
    /// The lookup mechanism to get account ID from whatever is passed in
    /// dispatchers.
    type Lookup = <OzSystem<Configuration> as frame_system::DefaultConfig>::Lookup;
    /// The maximum number of consumers allowed on a single account.
    type MaxConsumers = <OzSystem<Configuration> as frame_system::DefaultConfig>::MaxConsumers;
    /// The index type for storing how many extrinsics an account has signed.
    type Nonce = <OzSystem<Configuration> as frame_system::DefaultConfig>::Nonce;
    ...
    // Opinionated to override:
    /// The block type.
    type Block = Block;
    // TODO include in OzSystem<Runtime> impl for Runtime in oz_wrappers
...
impl pallet_scheduler::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    type MaxScheduledPerBlock = <Configuration as OzSystemConfig>::MaxScheduledPerBlock;
    type MaximumWeight = <Configuration as OzSystemConfig>::MaximumWeight;
    type RuntimeOrigin = <Configuration as OzSystemConfig>::RuntimeOrigin;
    type ScheduleOrigin = <Configuration as OzSystemConfig>::ScheduleOrigin;
...
impl pallet_preimage::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    type Consideration = <Configuration as OzSystemConfig>::PreimageConsideration;
    type ManagerOrigin = <Configuration as OzSystemConfig>::PreimageManagerOrigin;
...
impl pallet_timestamp::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    type MinimumPeriod = <OzSystem<Configuration> as pallet_timestamp::DefaultConfig>::MinimumPeriod;
    type Moment = <OzSystem<Configuration> as pallet_timestamp::DefaultConfig>::Moment;
...
impl pallet_proxy::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    type AnnouncementDepositBase = <Configuration as OzSystemConfig>::AnnouncementDepositBase;
    type AnnouncementDepositFactor = <Configuration as OzSystemConfig>::AnnouncementDepositFactor;
    type CallHasher = <OzSystem<Configuration> as frame_system::DefaultConfig>::Hashing;
    type MaxPending = <Configuration as OzSystemConfig>::MaxPending;
    type MaxProxies = <Configuration as OzSystemConfig>::MaxProxies;
    type ProxyDepositBase = <Configuration as OzSystemConfig>::ProxyDepositBase;
    type ProxyDepositFactor = <Configuration as OzSystemConfig>::ProxyDepositFactor;
...
impl pallet_balances::Config for Runtime {
    ...
    type Balance = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::Balance;
    type DustRemoval = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::DustRemoval;
    type ExistentialDeposit = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::ExistentialDeposit;
    type FreezeIdentifier = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::FreezeIdentifier;
    type MaxFreezes = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::MaxFreezes;
    type MaxLocks = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::MaxLocks;
    type MaxReserves = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::MaxReserves;
    type ReserveIdentifier = <OzSystem<Configuration> as pallet_balances::DefaultConfig>::ReserveIdentifier;
...
impl cumulus_pallet_parachain_system::Config for Runtime {
    // Will be generated by macro once derive_impl bugs fixed
    type CheckAssociatedRelayNumber = <Configuration as OzSystemConfig>::CheckAssociatedRelayNumber;
    type ConsensusHook = <Configuration as OzSystemConfig>::ConsensusHook;
    type DmpQueue = <Configuration as OzSystemConfig>::DmpQueue;
    type OnSystemEvent = <Configuration as OzSystemConfig>::OnSystemEvent;
    type OutboundXcmpMessageSource = <Configuration as OzSystemConfig>::OutboundXcmpMessageSource;
    type ReservedDmpWeight = <Configuration as OzSystemConfig>::ReservedDmpWeight;
    type ReservedXcmpWeight = <Configuration as OzSystemConfig>::ReservedXcmpWeight;
    type SelfParaId = <Configuration as OzSystemConfig>::SelfParaId;
    type XcmpMessageHandler = <Configuration as OzSystemConfig>::XcmpMessageHandler;

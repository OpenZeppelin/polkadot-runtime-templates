...
mod genesis_aura_tests {
    ...
    fn get_test_account_id(keyring: Sr25519Keyring) -> AccountId {
    ...
    fn aura_authorities_populated_at_genesis() {
        ...
        let alice_account = get_test_account_id(Sr25519Keyring::Alice);
        let bob_account = get_test_account_id(Sr25519Keyring::Bob);

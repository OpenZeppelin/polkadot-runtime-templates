...
/// have just one key).
pub fn template_session_keys(keys: AuraId) -> polkavm_runtime_template::SessionKeys {
    polkavm_runtime_template::SessionKeys { aura: keys }
}
...
pub fn development_config() -> ChainSpec {
    ...
    ChainSpec::builder(
        polkavm_runtime_template::WASM_BINARY.expect("WASM binary was not built, please build it!"),
        Extensions {
